...
CREATE TABLE `EmergencyRequest` (
    ...
    UNIQUE INDEX `EmergencyRequest_userId_key`(`userId`),
    INDEX `EmergencyRequest_userId_idx`(`userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `EmergencyRequest` ADD CONSTRAINT `EmergencyRequest_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
